...
public class MappingUtils {
    ...
    /*public static ParameterDTO EntityParamsToDTO(HyperparametersDB param){
        ParameterDTO test = modelMapper.map(param, ParameterDTO.class);
        if (param.getIntFloatRange()!=null){
            test.setType(TypeDTO.builder()
                            .
                    .build());
        } else if (param.getEnumRange()!=null) {
            test.setType(conversion(param.getEnumRange(), TypeDTO.class));
        } else if (param.getDictRange()!=null) {
            test.setType(conversion(param.getDictRange(), TypeDTO.class));
        }
        return test;
    }*/
